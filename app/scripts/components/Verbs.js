		...
		<section class="verbs table">
			<div class="container table-container">
				<header class="table-header">
					<h2 class="text--md">Verb Forms</h2>
				</header>
				<div class="table-content">
					<div class="table-item present-simple text--sm">
						...
						<div class="verb-plural">
							<span class="verb-prefix">I / You / We / They <strong>go</strong></span>
						...
						<div class="verb-singular">
							<span class="verb-prefix">he / she / it <strong>goes</strong></span>
							<div class="audio-group">
								<div class="audio-item audio-uk">
									<button class="audio-button text--xs" type="button">
										UK
									...
									<span class="audio-spell">/ɡəʊz/</span>
									<audio src="" type="audio/mpeg"></audio>
								</div>
								<div class="audio-item audio-us">
									<button class="audio-button text--xs" type="button">
					...
					<div class="table-item present-simple text--sm">
						<p class="verb-tense">
							Past simple <strong>went</strong>
						</p>
						<div class="audio-group">
							<div class="audio-item audio-uk">
								<button class="audio-button text--xs" type="button">
								...
								<span class="audio-spell">/went/</span>
								<audio src="" type="audio/mpeg"></audio>
							</div>
							<div class="audio-item audio-us">
								<button class="audio-button text--xs" type="button">
					...
					<div class="table-item present-simple text--sm">
						<p class="verb-tense">
							Past participle <strong>gone</strong>
						</p>
						<div class="audio-group">
							<div class="audio-item audio-uk">
								<button class="audio-button text--xs" type="button">
								...
								<span class="audio-spell">/ɡɒn/</span>
								<audio src="" type="audio/mpeg"></audio>
							</div>
							<div class="audio-item audio-us">
								<button class="audio-button text--xs" type="button">
								...
								<span class="audio-spell">/ɡɔːn/</span>
								<audio src="" type="audio/mpeg"></audio>
							</div>
						</div>
					</div>
					<div class="table-item present-simple text--sm">
						...
						<div class="audio-group">
							<div class="audio-item audio-uk">
								...
								<span class="audio-spell">/ˈɡəʊɪŋ/</span>
								<audio src="" type="audio/mpeg"></audio>
							</div>
							<div class="audio-item audio-us">
								<button class="audio-button text--xs" type="button">
